      ...
      <html>
       ...
       <h1>Simple Calculator Lab</h1>
        ...
        <legend class="light-border">Enter two numbers:</legend>
         ...
         <div class=\"main\">
          <label for=\"first\">First Number:</label><input type=\"text\" name=\"first\" required autofocus/><br />
          <label for=\"second\">Second Number:</label><input type=\"text" name=\"second\" required/><br />
...
app.listen(8080, () => {
    console.log('Your Server is running on 8080/simple-calc');
});